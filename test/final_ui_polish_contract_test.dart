...
void main() {
  ...
  test('startup screen preserves logo, Sumair attribution, and safe routing', () {
  ...
  test('assistant identity and execution details are observable, not hidden reasoning', () {
